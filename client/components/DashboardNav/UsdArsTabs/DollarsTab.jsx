...
const DollarsTab = ({token, navigation, USDbalance, ARSbalance, updateBalances}) => {
    ...
    const requestBuySell = () => {
        ...
        if(visibleBuy && ARSbalance < 200){
            ...
            text2: "Se requiere un balance mínimo de $200 en tu cuenta ARS para poder comprar dólares."
            });
        }
    ...
    const handleSell = () => {
        ...
        .then((res)=>{
            ...
            const gananciaARS = res.arsGained.toFixed(2)
        ...
        .catch(err=>{
            ...
            return Toast.show({
                type: "error",
                text1: "Hubo un error.",
                text2: "Por favor, comprueba tu conección a internet o ponte en contacto con el soporte.",
                onHide: cancel
            })
            }
        )
    ...
    return (<Layout style={{flex:1,...bn('py-6 px-6')}}>
        <KText category='h2' style={bn('mb-4 text-center')}>USD {USDbalance.toFixed(2)}</KText>
        <View style={bn('row')}>
